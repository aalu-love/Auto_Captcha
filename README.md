...
<img src="images/2.png" alt="no_image" width="85%"><br><br>
Step 3: Go the Chorme and open the Chrome Extension.<br>
<img src="images/3.png" alt="no_image" width="85%"><br><br>
Step 4: Enable the developer mode form the here.<br>
<img src="images/4.png" alt="no_image" width="85%"><br><br>
Step 5: Load the package and select the folder.<br>
<img src="images/5.png" alt="no_image" width="85%"><br><br>
